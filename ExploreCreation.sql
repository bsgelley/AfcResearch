...
page.original_namespace AS orig_namespace, page.original_title AS orig_title, enwiki_p.logging.log__type AS log_type, enwiki_p.logging.log_action AS log_action, enwiki_p.logging.log_timestamp AS log_timestamp, 
